...
urlpatterns = patterns('',
	...
	url(r'^profile/view/(?P<iduser>\d+)$', 'app.views.profile_page', name='profile'),
	...
	url(r'^subjects/(?P<idsubj>\d+)$', 'app.views.subject_page', name='subject'),
	...
	url(r'^admin/app/subject/(?P<idsubj>\d+)/csv/', 'app.admin_csv.relate_subject_user', 
														name='csv_relate_subject_user'),
